...
<section class="cover" id="cover">
    ...
    <div class="container cover-container">
        <div class="cover-flex-container reveal-up">
            <div class="cover-content">
                <div class="countdown-single-box" id="countdown">
                    <div class="countdown-item-inline">
            ...
            <div class="cover-side-panel">
                <div class="cover-dates-list vertical">
                    ...
                    <div class="cover-date-item">
                        <div class="date-label">Abstract Announcement</div>
                    ...
                    <div class="cover-date-item">
                        <div class="date-label">Full Paper Submission</div>
                        <div class="date-value">12 Oct – 12 Nov 2026</div>
                    </div>
                    <div class="cover-date-item">
...
<!-- About Section -->
<section class="about section-padding" id="about" style="padding: 20px 0;">
...
<!-- Themes and Subthemes Section -->
<section class="themes section-padding" id="themes" style="background-color: var(--bg-light);">
    <div class="container">
        ...
        <div class="themes-grid">
            <!-- Sub Theme 1 -->
            <div class="theme-item reveal-up">
                <i class="ph ph-tree theme-icon"></i>
                <h3 class="theme-title"><span>Sub Theme 1</span>Biodiversity Education through Geoparks, National Parks, and Landscape-Based Learning Systems</h3>
            </div>
            <!-- Sub Theme 2 -->
            <div class="theme-item reveal-up" style="transition-delay: 0.1s;">
                <i class="ph ph-plant theme-icon"></i>
                <h3 class="theme-title"><span>Sub Theme 2</span>Sustainable Management of Sub-optimal Lands and Post-Mining Landscapes</h3>
            </div>
            <!-- Sub Theme 3 -->
            <div class="theme-item reveal-up" style="transition-delay: 0.2s;">
                <i class="ph ph-users-three theme-icon"></i>
                <h3 class="theme-title"><span>Sub Theme 3</span>Nature-Based Livelihoods</h3>
            </div>
            <!-- Sub Theme 4 -->
            <div class="theme-item reveal-up" style="transition-delay: 0.3s;">
                <i class="ph ph-flask theme-icon"></i>
                <h3 class="theme-title"><span>Sub Theme 4</span>Biotechnology for Biodiversity, Environment, and Climate Change</h3>
            </div>
        </div>
...
<!-- Speakers Section -->
<section class="speakers section-padding bg-alt" id="speakers">
    <div class="container">
        <div class="section-header text-center reveal-up">
...
<!-- Schedule Section -->
<section class="schedule section-padding" id="schedule">
    <div class="container">
        <div class="section-header text-center reveal-up">
            <span class="section-subtitle">Event Timeline</span>
...
<section class="pricing section-padding bg-alt" id="pricing">
    <div class="container">
        <div class="section-header text-center reveal-up">
            <span class="section-subtitle">Join The Conference</span>
            ...
            <p class="mt-4" style="color: var(--text-muted); max-width: 600px; margin: 0 auto; font-size: 1.1rem;">
                Detailed information regarding conference fees for both foreign and Indonesian participants, as well as publication fees, is available on our registration page.
            </p>
        </div>
        
        <div class="text-center reveal-up" style="transition-delay: 0.1s; margin-bottom: 40px;">
            <a href="registration.php" class="btn btn-primary" style="padding: 16px 40px; font-size: 18px;">
                View Pricing & Register Now <i class="ph-bold ph-arrow-right"></i>
            </a>
        </div>
    </div>
</section>
...
<section class="location section-padding" id="location" style="padding-bottom: 20px;">
    <div class="container">
        <div class="section-header text-center reveal-up">
            ...
            <h2 class="section-title">Conference Location</h2>
        </div>
        <div class="location-content reveal-up">
